function skillsInfos(bat,batUnitType) {
    ...
    if (anyRavit && bat.tags.includes('ammoUsed')) {
        ...
        if (bat.apLeft >= apCost) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Ravitaillement</h4></span>');
        }
    }
    // STOCKS
    ...
    if (anyStock && bat.tags.includes('skillUsed')) {
        ...
        if (bat.apLeft >= apCost) {
            ...
            skillMessage = "Pas assez de PA";
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Réapprovisionnement</h4></span>');
        }
    }
    // GUET
    if (batUnitType.weapon.rof >= 1 && !batUnitType.skills.includes('sentinelle') && batUnitType.ap >= 1) {
        ...
        if (bat.apLeft >= apReq && !bat.tags.includes('guet')) {
            ...
            // pas assez d'ap
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="Vous devez avoir '+apReq+' PA restant, même si le coût n\'est que de 3" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Guet</h4></span>');
        }
    }
    // FORTIFICATION
    if (batUnitType.skills.includes('fortif')) {
        ...
        if (bat.apLeft >= apCost && !bat.tags.includes('fortif') && !inMelee && bat.salvoLeft >= batUnitType.maxSalvo) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Fortification</h4></span>');
        }
    }
    // CAMOUFLAGE
    if (batUnitType.skills.includes('camo')) {
        ...
        if (bat.apLeft >= 1 && bat.fuzz >= -1) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Mode furtif</h4></span>');
        }
    ...
    if (batUnitType.skills.includes('embuscade')) {
        ...
        if (bat.apLeft >= apCost && bat.tags.includes('camo')) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Embuscade</h4></span>');
        }
    }
    // TIR CIBLE
    ...
    if (batUnitType.skills.includes('cible')) {
        ...
        if (bat.apLeft >= apCost && !bat.tags.includes('vise')) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><'+balise+'><button type="button" title="Pas assez de PA" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Tir ciblé</'+balise+'></span>');
        }
    }
    // LUCKY SHOT
    if (batUnitType.skills.includes('luckyshot')) {
        ...
        if (!bat.tags.includes('luckyshot') && !bat.tags.includes('lucky')) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><'+balise+'><button type="button" title="Pas assez de bol" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Lucky shot</'+balise+'></span>');
        }
    }
    // MEDIC
    if (batUnitType.skills.includes('medic')) {
        ...
        if (bat.apLeft >= 4 && numTargets >= 1 && !inMelee) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Soins</h4></span>');
        }
    }
    // SELF MEDIC
    ...
    if (batUnitType.skills.includes('firstaid')) {
        ...
        if (bat.apLeft >= batUnitType.ap && damaged && !inMelee) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Premiers soins</h4></span>');
        }
    }
    // MECANO
    if (batUnitType.skills.includes('mecano')) {
        ...
        if (bat.apLeft >= 8 && numTargets >= 1 && !inMelee) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Dépannage</h4></span>');
        }
    }
    // SELF MECANO
    if (batUnitType.skills.includes('selfmecano')) {
        ...
        if (bat.apLeft >= batUnitType.ap && damaged && !inMelee) {
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="Retaper le véhicule" class="boutonGris iconButtons" onclick="medic(`vehicles`,'+apCost+',false,false)"><i class="fa fa-hammer"></i> <span class="small">'+apCost+'</span></button>&nbsp; Dépannage</h4></span>');
        } else {
            if (!damaged) {
    ...
    if (batUnitType.skills.includes('repair') && !inMelee) {
        ...
        if (bat.apLeft >= 8 && numTargets >= 1 && !inMelee) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Réparations</h4></span>');
        }
    }
    // SELF REPAIR
    ...
    if (batUnitType.skills.includes('landmine')) {
        ...
        if (minesLeft >= 1 && bat.apLeft >= batUnitType.ap && !inMelee) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Champ de mines</h4></span>');
        }
    }
    // POSE DYNAMITE
    if (batUnitType.skills.includes('dynamite')) {
        ...
        if (minesLeft >= 1 && bat.apLeft >= batUnitType.ap && !inMelee) {
            ...
            $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Explosifs</h4></span>');
        }
    }
    // DROGUES
    if (!batUnitType.skills.includes('mutant') && batUnitType.cat === 'infantry') {
        ...
        if (allDrugs.includes('kirin') && !bat.tags.includes('kirin')) {
            ...
            if (bat.apLeft >= apCost) {
                ...
                skillMessage = "Pas assez de PA";
                $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Kirin</h4></span>');
            }
        }
        // BLISS
        if (allDrugs.includes('bliss') && !bat.tags.includes('bliss')) {
            ...
            if (bat.apLeft >= apCost) {
                ...
                skillMessage = "Pas assez de PA";
                $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Bliss</h4></span>');
            }
        }
        // BLAZE
        if (allDrugs.includes('blaze') && !bat.tags.includes('blaze')) {
            ...
            if (bat.apLeft >= apCost) {
                ...
                skillMessage = "Pas assez de PA";
                $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Blaze</h4></span>');
            }
        }
        // SKUPIAC
        if (allDrugs.includes('skupiac') && !bat.tags.includes('skupiac')) {
            ...
            if (bat.apLeft >= apCost) {
                ...
                skillMessage = "Pas assez de PA";
                $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Skupiac</h4></span>');
            }
        }
        // SILA
        if (allDrugs.includes('sila') && !bat.tags.includes('sila')) {
            ...
            if (bat.apLeft >= apCost) {
                ...
                skillMessage = "Pas assez de PA";
                $('#unitInfos').append('<span class="blockTitle"><h4><button type="button" title="'+skillMessage+'" class="boutonGris iconButtons">&nbsp; <span class="small">'+apCost+'</span></button>&nbsp; Sila</h4></span>');
            }
        }
    }
    // DISMANTLE
