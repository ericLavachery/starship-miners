    ...
    if (prefabId >= 0) {
        ...
        if (batType.skills.includes('constructeur') && !bat.tags.includes('nomove')) {
            ...
            if (selectedBatType.cat === 'infantry') {
                if (prefabBatType.fabTime >= 35 && !prefabBatType.skills.includes('clicput') && (!prefabBatType.skills.includes('infconst') || playerInfos.comp.const < 1)) {
                    depliOK = false;
                }
            }
            let damageOK = true;
            ...
            if (bat.loc === "trans") {
                ...
                if (batType.skills.includes('prefab')) {
                    ...
                    if (myBatUnitType.cat === 'infantry') {
                        if (batType.fabTime >= 35 && !batType.skills.includes('clicput') && (!batType.skills.includes('infconst') || playerInfos.comp.const < 1)) {
                            depliOK = false;
                        }
                    }
                    if (bat.apLeft <= 0) {
