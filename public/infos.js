...
function batInfos(bat,pop) {
    ...
    if (batType.skills.includes('camo') || batType.skills.includes('maycamo') || tile.ruins || bat.eq === 'crimekitgi' || bat.eq === 'crimekitch' || bat.eq === 'e-camo' || (bat.eq === 'kit-guetteur' && playerInfos.comp.train >= 1)) {
