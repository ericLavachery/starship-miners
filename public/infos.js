...
function batInfos(bat,batType,pop) {
    ...
    if (batType.skills.includes('camo') || batType.skills.includes('maycamo') || batType.skills.includes('aicamo') || tile.ruins || bat.eq === 'crimekitgi' || bat.eq === 'crimekitch' || bat.eq === 'e-camo' || bat.logeq === 'e-camo' || (bat.eq === 'kit-guetteur' && playerInfos.comp.train >= 1) || (bat.eq === 'kit-chouf' && playerInfos.comp.train >= 1)) {
