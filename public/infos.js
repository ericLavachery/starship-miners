...
function batInfos(bat,batType,pop) {
    ...
    if (batType.skills.includes('camo') || batType.skills.includes('maycamo') || (batType.skills.includes('aicamo') && playerInfos.comp.cam >= 1) || tile.ruins || tile.terrain === 'F' || bat.eq === 'kit-sentinelle' || bat.eq === 'kit-milice' || bat.eq === 'crimekitgi' || bat.eq === 'crimekitch' || bat.eq === 'crimekitlu' || bat.eq.includes('silencieux') || bat.logeq.includes('silencieux') || bat.eq === 'e-camo' || bat.logeq === 'e-camo' || (bat.eq === 'kit-guetteur' && playerInfos.comp.train >= 1) || (bat.eq === 'kit-chouf' && playerInfos.comp.train >= 1)) {
