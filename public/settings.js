...
let gangLevelCit = [0,1000,1400,1800,2200,2600,3000,3400,3800,4200,4600,5000,5400,5850,6300,6750,7200,7650,8100,8550,9000,10000,11000];
let gangXPFactor = 27;
let myCompPoints = 0;
// ACTIONS
...
let mcSudu = 0.84; // moveCost x mcSudu
let isReloaded = true;
...
// SOUNDS
let musicChance = 2;
let musicTracks = ['amb_trucsympa','amb_space2','amb_ambiant1','parallel_dimensions','amb_trucsympa','amb_ambiant2','amb_space1','aftermath','it_is_raped'];
