                            ...
                            if (catOK && !batType.skills.includes('norepair')) {
                                ...
                                if (cat === 'infantry') {
                                    ...
                                    if (bat.squadsLeft === batType.squads && bat.damage > 0) {
                                        ...
                                        regen = getMecaHP(batType,selectedBatType);
    ...
    if (catOK) {
        ...
        if (cat === 'infantry') {
            ...
            if (selectedBat.squadsLeft === selectedBatType.squads && selectedBat.damage > 0) {
                ...
                regen = getMecaHP(selectedBatType,selectedBatType);
...
function getMecaHP(batType,mecaBatType,roborepair) {
    ...
    if (batType.skills.includes('transorbital')) {
        ...
        regen = Math.round(mecanoHP*(playerInfos.comp.det+3)/5);
    } else {
        regen = Math.round(mecanoHP*(playerInfos.comp.trans+3)/5);
    }
    return regen;
}
...
function diagRepair(repairBatId) {
    ...
    let regen = getMecaHP(selectedBatType,repairBatType);
