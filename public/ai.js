                ...
                if (distance === 0) {
                    ...
                    if (batType.moveCost < 99) {
                        if (blob) {
                            ...
                            if (batType.skills.includes('berserk') || batType.skills.includes('mutant') || batType.skills.includes('robot') || batType.skills.includes('nofear') || bat.tags.includes('zombie')) {
                                fearChance = 0;
                            } else {
